  ...
  const CreateEventSection = ({
    ...
    return (
      <form
        ...
        className="w-full h-auto flex flex-col justify-center p-9"
      >
        <div className="flex w-full h-full justify-between items-center z-40">
          ...
          >
            <ChevronLeft
              className="w-4 text-[var(--background)]"
              strokeWidth={3}
            />
          </div>
        ...
        <div className="flex flex-col items-center justify-center">
          <LocationSelect
            ...
            onSelect={(lat: number, lng: number, selectedAddr?: string) => {
              ...
              formik.setFieldValue("address", selectedAddr);
          ...
          {!showCreateEventDialog ? (
            ...
            <div className="w-full max-w-xl space-y-5">
              <div className="flex flex-col justify-center items-center w-full bg-[#28272A] border border-[#28272A] rounded-2xl mt-5 p-5 text-center gap-3">
        ...
        <div className="flex flex-col w-full space-x-4 mt-5 gap-4">
          ...
          <GallerySection
            ...
            setBackgroundImage={(image) =>
              formik.setFieldValue("backgroundImage", image)
            }
            touched={{
