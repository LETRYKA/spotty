    ...
    <div className="w-full h-auto grid grid-cols-2 lg:grid-cols-5 sm:grid-cols-4 xs:grid-cols-3 xl:grid-cols-6 gap-10 mt-8 px-8">
      {eventsWithStatus.map((event) => {
        ...
        return (
          <div
            key={event.id}
            className="w-full bg-[#313034] flex flex-col rounded-3xl items-center relative transition-transform duration-300 ease-in-out transform hover:scale-105 hover:shadow-xl"
          >
            <img
              src={Mapping.src}
              alt="Event"
              className="w-full h-auto aspect-square rounded-3xl object-cover"
            />
            <div className="absolute top-4 bottom-4 left-6 right-6">
              ...
              <div className="absolute w-full bottom-2">
                ...
                <div className="w-full h-auto flex flex-gap justify-between bg-white mt-4 top-47 rounded-2xl px-4 py-3 gap-3">
